    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filterIcon.setOnClickListener(v -> {
            if (isAscending) {
                ...
                Toast.makeText(this, "الأقل سعراً", Toast.LENGTH_SHORT).show();
            } else {
                productList.sort((p1, p2) -> Double.compare(p2.getPrice(), p1.getPrice()));
                Toast.makeText(this, "الأعلى سعراً", Toast.LENGTH_SHORT).show();
            }
        ...
        fabQuickAction.setOnClickListener(v -> Toast.makeText(this, "قيد التطوير", Toast.LENGTH_SHORT).show());
    }
    @Override
