...
public class UserManager {
    ...
    public static synchronized UserManager getInstance() {
        if (instance == null) throw new IllegalStateException("UserManager must be initialized with context first");
        return instance;
    }
    public void registerUser(String fullName, String email, String phone, String password) {
        sharedPreferences.edit().putString(USER_KEY, gson.toJson(new User(fullName, email, phone, password))).apply();
    }
